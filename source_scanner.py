"""
Модуль для статического анализа исходного кода на наличие опасных паттернов.

Содержит:
- Набор правил (SOURCE_RULES) для поиска уязвимостей (eval, document.write, innerHTML, shell=True, секреты и др.)
- Функции для обхода файлов проекта с учётом игнорируемых директорий и расширений
- Поиск совпадений с извлечением номера строки и контекстного фрагмента кода

Возвращает список найденных уязвимостей с указанием файла, строки, описанием и рекомендацией.
"""
